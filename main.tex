...
\includepdf{data/copyright-signed.pdf}             % 使用pdf文件替换原有的诚信声明data/copyright
...
\addcontentsline{toc}{chapter}{指导教师对研究生学位论文的学术评语}
\includepdf{data/comment-signed.pdf}
\includepdf{data/blank.pdf}
\addcontentsline{toc}{chapter}{学位论文答辩委员会决议书}
\includepdf{data/resolution.pdf}
\includepdf{data/resolution2.pdf}
